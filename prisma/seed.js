...
const main = async () => {
  ...
  const posts = [
    ...
    },
    {
      ...
      regionId: 6,
      imageUrl: ["https://img.siksinhot.com/place/1470101096233501.jpg?w=540&h=436&c=Y"],
      userId: 1
    },
    {
      title: "우진해장국",
      content: "전복을 넣어 끓인 고사리 해장국으로 유명한 맛집입니다. 50년이 넘는 전통을 이어오고 있습니다. 공깃밥을 말아먹는 해장국, 뚝배기에서 보글보글 끓여먹는 해장국을 맛볼 수 있습니다.",
      regionId: 6,
      imageUrl: ["https://img.siksinhot.com/place/1605598616336762.jpg?w=540&h=436&c=Y"],
      userId: 1
    }
  ];
